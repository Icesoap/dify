...
// import type { AppIconType, AppMode, ModelConfig, AppCategory } from '@/types/app'
...
export const updateAppInfo: Fetcher<AppDetailResponse, {
  appID: string
  name: string
...
}> = ({ appID, name, icon_type, icon, icon_background, description, use_icon_as_answer_icon }) => {
  return put<AppDetailResponse>(`apps/${appID}`, { body: { name, icon_type, icon, icon_background, description, use_icon_as_answer_icon } })
}

export const copyApp: Fetcher<AppDetailResponse, {
  appID: string
  name: string
  icon_type: AppIconType
  icon: string
...
// TODO: delete
export const importApp: Fetcher<AppDetailResponse, {
  data: string
  name?: string
  description?: string
  icon_type?: AppIconType
  icon?: string
  icon_background?: string
}> = ({ data, name, description, icon_type, icon, icon_background }) => {
  return post<AppDetailResponse>('apps/import', { body: { data, name, description, icon_type, icon, icon_background } })
}

// TODO: delete
export const importAppFromUrl: Fetcher<AppDetailResponse, { url: string; name?: string; description?: string; icon?: string; icon_background?: string }> = ({
  url,
  name,
  description,
  icon,
...
export const importDSL: Fetcher<DSLImportResponse, {
  mode: DSLImportMode
  yaml_content?: string
  yaml_url?: string
  app_id?: string
  ...
  icon?: string
  icon_background?: string
}> = ({ mode, yaml_content, yaml_url, app_id, name, description, icon_type, icon, icon_background }) => {
...
export const switchApp: Fetcher<{ new_app_id: string }, { appID: string; name: string; icon_type: AppIconType; icon: string; icon_background?: string | null }> = ({
  appID,
  name,
  icon_type,
  icon,
